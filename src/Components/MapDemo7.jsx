                    ...
                    {products.map((prod, index) => {
                        return (
                            <tr>
                                ...
                                <td>{prod.name}</td>
                                <td>{prod.brand}</td>
                                <td style={{backgroundColor : prod.category == "Electronics" && "yellow"}}>{prod.category}</td> 
                                <td>{prod.subCategory}</td>
                                <td style={{backgroundColor : prod.discountPercentage > 20 && "blue"}}>{prod.discountPercentage}</td>
                                <td style={{color : prod.finalPrice > 4000 && "purple"}}>{prod.finalPrice}</td>
                                <td style={{color : prod.rating < 4.5 && "red"}}>{prod.rating}
                                    {
                                        prod.rating > 4.5 && " *****"
                                    }
                                </td>
                                <td style={{backgroundColor : prod.stock < 50 && "red"}}>{prod.stock}</td>
                                <td>{prod.sku}</td>
